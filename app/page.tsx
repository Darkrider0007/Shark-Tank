...
export default function Home() {
  return (
    <>
      <div className='min-h-screen bg-[#2a2828] overflow-hidden overscroll-none flex justify-center  text-white'>
      <Image
      ...
      />
      <div className='z-10 flex items-center flex-col mt-20 gap-4'>
        ...
        <button className='mt-6 rounded-full border-white border-2 px-4 py-2 hover:underline hover:border-b-4'>See more →</button>
      </div>
      </div>      
    </>
  )
